...
const STATIC_BG =
  'radial-gradient(circle at 20% 20%, rgba(112, 9, 183, 0.14), transparent 45%), radial-gradient(circle at 80% 30%, rgba(83, 52, 131, 0.16), transparent 40%), #06060a';
    ...
    >
      <div className="relative min-h-screen overflow-x-hidden" style={{ height: '100%' }}>
        <div style={{ position: "fixed", inset: 0, zIndex: 10 }}>
          <div className="h-full w-full" style={{ background: STATIC_BG }} />
        </div>
