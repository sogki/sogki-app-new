...
async function handleChat(req: Request) {
  ...
  const system = [
    ...
    'You may use Discord-style markdown for structure:',
    '# Title (largest), ## Section, ### Subsection — more # marks = smaller text.',
    'Also **bold**, *italic*, and bullet lists (- item or • item).',
